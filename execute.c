...
/*   Updated: 2025/07/01 17:44:08 by syanak           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	execute_command(t_base *base)
{
	...
	// Enumlar 0123456 (TOKEN_WORD = 0 TOKEN_QUOTED_WORD = 6) diye sıralanır sadece token olduğuna bakarsak tırnek içerindeki word u build in de ele alamayız.
	{
